...
resultscor.awakeaverage=awake_average;
...
set(gca, 'YTickLabel', s); set(gca, 'XTickLabel', s);
axis xy; axis tight; colorbar('location','EastOutside');
resultscor.awakeaveragepos=awake_average_pos;
resultscor.awakethr=threshold_awake;
...
resultscor.sleepaverage=sleep_average;
...
resultscor.sleepavgpos=sleep_average_pos;
% Plot
...
resultscor.couple_sleep=couple_sleep;
...
resultscor.couple_sleep_values=couple_sleep_values;
...
resultscor.couple_awake=couple_awake;

% this is the values of the correlation coefficient for the most active
% channels
for kk=1:crank, couple_awake_values(kk)=Megisti(kk); end;
resultscor.couple_awake_values=couple_awake_values;
...
set(gca,'Ytick', 1:nchan); set(gca, 'XTick', 1:nchan); set(gca, 'YTickLabel', s); set(gca, 'XTickLabel', s);
axis xy; axis tight; colorbar('location','EastOutside');
resultscor.awake_sleep=difwk_sl;
...
resultscor.couple_diff_awake_sleep=couple_diff_awake_sleep;
...
resultscor.diff_couple_awak_sl_values=couple_diff_awake_sleep_values;
...
axis xy; axis tight; colorbar('location','EastOutside');
% save in structure
resultscor.sleep_awake=difsl_wk;
...
% save
resultscor.couple_diff_sleep_awake=couple_diff_sleep_awake;
resultscor.couple_diff_sleep_awake_values=couple_diff_sleep_awake_values;
...
resultscor.sleep_awake_thr=difsl_wk_pos;
