function [PC]=assymetry_index_pc_forDIM(result1, timeTosleep, timeEndsleep, B, xyz, textmeasure, timeVec2, num_epochs, nchan,s, name, now)
...
PC.awakethreshold=threshold_awake;
...
PC.sleepthreshold=threshold_sleep;
