 %% DTF computation 3-5-2011, 3-6-2011
...
DTFT=assymetry_index_dtf(connectivity_measure, timeTosleep, timeEndsleep, B, xyz, 'DTF', num_epochs, nchan, s, name,now);
...
DTFtheta.gamma2_all=gamma2_all;
DTFtheta.gamma_Freq=gammaFreq;
DTFtheta.gamma_time=meanA;
DTFtheta.p=p;
DTFtheta.low_freq=low_freq;
DTFtheta.high_freq=high_freq;
save DTFtheta DTFtheta -v7.3
